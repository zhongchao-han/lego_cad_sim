...
class TestGeometryProcessorHoles:
    ...
    def test_axlehol_scaled_ports(self, mock_resolve, processor):
        ...
        with patch("builtins.open", new=mock_open_file):
            ...
            # Actually, check logic. If z_hat0 is [0, 0, 1], adjust assertion to match code logic if correct.
            # LDU matrix: 1 16 0 0 10 -1 0 0 0 0 -1 0 -20 0 axlehol6.dat
            # Trans: [0, 0, 10]
            # Rot: [-1 0 0; 0 0 -1; 0 -20 0] -> Wait, the scale is on Z?
            # z_hat0 generated by geometry_processor based on port definition logic.
